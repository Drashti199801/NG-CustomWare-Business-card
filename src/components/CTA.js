function CTA(){
    return(
        <div className="cta">
            <a href="mailto:rohan@nextgencustomware.ca" className="cta-btn cta-btn-email">
            ...
            <a href="https://www.linkedin.com/company/105976399/admin/dashboard/" className="cta-btn cta-btn-linkedin">
            <span className="cta-btn-icon">
